...
//    'default_parse_mode' => Telegraph::PARSE_HTML,
    ...
    /* 'SOURCE_CHAT_ID' is the ID of the group or channel from which you want to forward messages */
    'source_chat' => env('TELEGRAM_SOURCE_CHAT_ID', false),
    /* 'TARGET_CHAT_ID' is the ID of the chat to forward the message to */
    'target_chat' => env('TELEGRAM_TARGET_CHAT_ID', false),
];
